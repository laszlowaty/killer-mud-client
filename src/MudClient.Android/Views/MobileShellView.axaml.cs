...
public sealed partial class MobileShellView : UserControl
{
    ...
    private void RoomTab_OnClick(object? sender, RoutedEventArgs eventArgs) =>
        SelectAuxiliaryTab("Room");
    ...
    private void SelectAuxiliaryTab(string activeTab)
    {
        ...
        var roomButton = this.FindControl<Avalonia.Controls.Primitives.ToggleButton>("RoomTabButton");
        ...
        var roomPanel = this.FindControl<Control>("MobileRoomPanel");
        ...
        if (roomButton is not null) roomButton.IsChecked = activeTab == "Room";
        ...
        if (roomPanel is not null) roomPanel.IsVisible = activeTab == "Room";
    }
