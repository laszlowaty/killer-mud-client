...
internal static class TeacherCatalogLoader
{
    ...
    [
        ...
        S("seize soul", 0, 30, 20, 30, "14067", "Nauczycielka Naenna", "Cmentarz", "Carrallak", "Mag"),
        S("seize soul", 0, 30, 20, 30, "27586", "Zakapturzony rycerz", "Podmrok - Seeyma", "Forteca", "Czarny Rycerz"),
        S("seize soul", 0, 30, 30, 30, "6779", "Czarny strażnik", "Cmentarzysko", "Arras", "Czarny Rycerz"),
        S("seize soul", 0, 30, 30, 30, "34713", "Czarny rycerz", "Szkoła - Czarny Rycerz", "Szkoła Czarnego Rycerza", "Czarny Rycerz"),
        S("seize soul", 0, 30, 30, 30, "250", "Nauczyciel", "Carrallak", "Carrallak", "Czarny Rycerz"),
        S("seize soul", 0, 40, 0, 0, "16703", "Drowi czarodziej", "Messholzarn", "Podmrok", "Mag"),
        S("seize soul", 28, 55, 45, 30, "2024", "Terminator upiornego rycerza", "Cmentarz", "Forteca", "Czarny Rycerz"),
        S("seize soul", 30, 65, 60, 43, "16817", "Uwięziony duch", "Podmrok gobliny", "Podmrok", "Mag"),
        S("seize soul", 45, 75, 65, 45, "33013", "Władca mroku", "Nawiedzone Hale", "Arras", "Czarny Rycerz"),
        S("seize soul", 50, 85, 75, 50, "11150", "Ponura trucicielka", "Podziemia nekromanty", "Forteca", "Czarny Rycerz"),
        S("seize soul", 70, 95, 65, 75, "25900", "Zgarbiony demon", "Ścieżka, las, podziemia", "Forteca", "Czarny Rycerz"),
        S("seize soul", 75, 95, 85, 75, "43072", "Rycerz śmierci", "Wyspa nieumarłych", "Carrallak", "Czarny Rycerz"),

        S("claws mastery", 0, 45, 60, 35, "2508", "Druid Iverl", "Wyspa obłąkanych", "Carrallak", "Druid"),
        S("claws mastery", 40, 70, 65, 40, "1660", "Stary druid", "Druidzki Krąg", "Carrallak", "Druid"),
        S("claws mastery", 60, 85, 80, 60, "42832", "Druidka Della", "Góry na zachód od Fortecy", "Forteca", "Druid"),
        S("claws mastery", 80, 95, 90, 80, "16288", "Duch druida", "[NK] Śnieżne równiny", "Easterial", "Druid"),
